...
import com.org.foodAdventures.repository.BookingDetailsRepository;
...
public class BookingService {
    ...
    public List<BookingDetails> getBookingDetailsByUsername(String bookedBy) {
        ...
        // log.info("username = " + username + ",age = "+ age + ", gender = " + gender + ", profilePic = " + profilePic + ", bio = " + bio);
         return bookingRepository.getBookingDetailsByUsername(bookedBy);
    }
    ...
    @Transactional
    public void insertBooking(String restaurantId, String bookedBy,String bookedFor,String contactNo) {
        // fileURL = this.storePhoto(username, photo);
        int recordedAffected = bookingRepository.insertBooking(restaurantId, bookedBy, bookedFor, contactNo);
